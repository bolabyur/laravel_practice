<div id="createGuardianModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-96 p-6 relative">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Tambah Guardian</h2>
        ...
        <form action="{{ route('admin.guardian.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="job" class="block text-gray-700 dark:text-gray-200 mb-1">Job</label>
            ...
            <div class="flex justify-end gap-2">
                <button type="button" data-modal-hide="createGuardianModal"
