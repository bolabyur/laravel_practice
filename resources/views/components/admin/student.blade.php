            ...
            <tbody>
                @foreach ($students as $i => $student)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <!-- Dropdown Menu -->
                            <button id="dropdownMenuIconHorizontalButton-{{ $student->id }}"
                                data-dropdown-toggle="dropdownDotsHorizontal-{{ $student->id }}"
                            ...
                            <!-- Dropdown menu -->
                            <div id="dropdownDotsHorizontal-{{ $student->id }}"
                                class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    aria-labelledby="dropdownMenuIconHorizontalButton-{{ $student->id }}">
                                    <li>
                                        <button type="button" data-modal-target="editStudentModal-{{ $student->id }}"
                                    ...
                                    <div class="grid gap-4 grid-cols-1 p-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="email" name="email" id="email"
                                                ...
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                placeholder="Masukkan email student">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="address" id="address"
                                                ...
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                placeholder="Masukkan alamat student">
                                        </div>
                                            ...
                                            <select name="classroom_id" id="classroom_id" required
                                                ...
                                                @foreach ($classrooms as $classroom)
                                                    <option value="{{ $classroom->id }}"
                                                        ...
                                                        class="text-gray-900 bg-white dark:bg-gray-600 dark:text-white">
                                                        {{ $classroom->class }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                ...
                                <form action="{{ route('admin.student.destroy', $student->id) }}" method="POST">
                                    ...
                                    <p class="mb-4 text-gray-500 dark:text-gray-300">
                                        Apakah Anda yakin ingin menghapus student
                                        <strong
                                            class="font-semibold text-gray-900 dark:text-white">{{ $student->name }}</strong>?
                                    </p>
