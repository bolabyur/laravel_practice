                ...
                <ul class="space-y-2">
                    <li>
                        @include('components.admin.sidelink', [
                            ...
                            'svg' =>
                                '<svg width="26px" height="26px" viewBox="-1.2 -1.2 26.40 26.40" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_iconCarrier"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.5192 7.82274C2 8.77128 2 9.91549 2 12.2039V13.725C2 17.6258 2 19.5763 3.17157 20.7881C4.34315 22 6.22876 22 10 22H14C17.7712 22 19.6569 22 20.8284 20.7881C22 19.5763 22 17.6258 22 13.725V12.2039C22 9.91549 22 8.77128 21.4808 7.82274C20.9616 6.87421 20.0131 6.28551 18.116 5.10812L16.116 3.86687C14.1106 2.62229 13.1079 2 12 2C10.8921 2 9.88939 2.62229 7.88403 3.86687L5.88403 5.10813C3.98695 6.28551 3.0384 6.87421 2.5192 7.82274ZM9 17.25C8.58579 17.25 8.25 17.5858 8.25 18C8.25 18.4142 8.58579 18.75 9 18.75H15C15.4142 18.75 15.75 18.4142 15.75 18C15.75 17.5858 15.4142 17.25 15 17.25H9Z" fill="currentColor"></path></g></svg>',
                        ])
                    </li>
                    <li>
                        <button type="button"
...
<ul id="dropdown-pages" class="hidden py-2 space-y-1">
    <li>
        <a href="/admin/classroom"
            class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg transition duration-150 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
            <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8"
                stroke-linecap="round" stroke-linejoin="round"
                class="w-5 h-5 text-gray-500 transition duration-150 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white">
                <path d="M4 4h16v12H4z"></path>
                <path d="M22 20H2"></path>
                <path d="M8 8h8v4H8z"></path>
            </svg>
    ...
    <li>
        <a href="/admin/guardian"
            ...
            <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8"
                ...
                <path d="M2 21v-2a4 4 0 0 1 4-4h5"></path>
                <path d="M14 21v-2a4 4 0 0 1 4-4h2"></path>
            </svg>
            <span class="ml-3">Guardian</span>
        </a>
    </li>
    ...
    <li>
        <a href="/admin/teacher"
            ...
            <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8"
                ...
                <path d="M8 15h8a4 4 0 0 1 4 4v1H4v-1a4 4 0 0 1 4-4z"></path>
            </svg>
