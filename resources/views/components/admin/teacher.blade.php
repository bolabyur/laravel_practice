                        ...
                        <td class="px-6 py-4">
                            ...
                            <div id="dropdownDotsHorizontal-{{ $item->id }}" 
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton-{{ $item->id }}">
                                    ...
                                    <li>
                                        <button type="button" 
                                                data-modal-target="deleteTeacherModal-{{ $item->id }}" 
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                                    ...
                                    <button type="button" 
                                            data-modal-hide="editTeacherModal-{{ $item->id }}"
                                ...
                                <form action="{{ route('admin.teacher.update', $item->id) }}" method="POST" class="p-4 md:p-5">
                                    @csrf
                                    @method('PUT')
                                    <div class="grid gap-4 mb-4 grid-cols-1">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="phone" id="phone" value="{{ $item->phone }}" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="address" id="address" value="{{ $item->address }}" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                placeholder="Masukkan alamat teacher">
                                        </div>
                                    </div>
                            ...
                            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                ...
                                <form action="{{ route('admin.teacher.destroy', $item->id) }}" method="POST">
                                    ...
                                    <p class="mb-4 text-gray-500 dark:text-gray-300">
                                        Apakah Anda yakin ingin menghapus teacher 
    ...
    <div id="addTeacherModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form action="{{ route('admin.teacher.store') }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
